...
2. Extract the specific skill into 'skillName' (translate skillName to ${targetLang} if the input is in another language).
3. Estimate 'experienceLevel' in ${targetLang} (e.g. Beginner, Intermediate, Expert, or X years).
